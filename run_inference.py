...
def load_model(session, saver):
    """
    Load the best model like the agent.py does it.
    """
    print('Loading Model...')
    latest_checkpoint = tf.train.latest_checkpoint('/home/nvidia/TFSegmentation/experiments/fcn8_shufflenet/checkpoint')
